...
void main() {
  testWidgets(
    'Sonus Auris paints a responsive loading frame before plugin bootstrap',
    (tester) async {
      tester.view
  ...
  testWidgets(
    'controller construction failures become an explicit error page',
    (tester) async {
      await tester.pumpWidget(
        AudioDashcamRoot(
          controllerFactory: () =>
              throw StateError('synthetic bootstrap failure'),
        ),
      );
      await tester.pump();
