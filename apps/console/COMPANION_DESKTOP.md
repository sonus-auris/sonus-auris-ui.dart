...
This directory is the **live Flutter web/native device console** for Sonus Auris. It is an additional operator surface inside the canonical Flutter repository, not the sole Flutter half of the dual-desktop product pair.

## Canonical product pair

- Rust: [`sonus-auris/sonus-auris-desktop.rs`](https://github.com/sonus-auris/sonus-auris-desktop.rs) — **live** pure-Rust desktop recorder/viewer.
- Flutter: [`sonus-auris/sonus-auris-flutter.dart`](https://github.com/sonus-auris/sonus-auris-flutter.dart) — **live** canonical Flutter mobile/desktop product application.
- Console: `apps/console` in `sonus-auris-flutter.dart` — **live**; this directory.
