...
// Register the callback for unpackaged builds under the current user. A
// packaged installer can declare and replace the same protocol association.
...
int APIENTRY wWinMain(_In_ HINSTANCE instance, _In_opt_ HINSTANCE prev,
  ...
  RegisterUrlProtocol(L"sonusauris-console",
                      L"URL:Sonus Auris console authentication");
  ...
  if (!window.Create(L"sonus_auris_console", origin, size)) {
    return EXIT_FAILURE;
  }
