...
///
/// This model intentionally carries no audio, transcript, path, remote key,
/// provider error, token, or encryption material. It is safe to show in the
/// privacy dashboard and to count in diagnostics without leaking content.
